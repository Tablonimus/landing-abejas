...
<section className="relative pt-20 pb-16 md:pt-28 md:pb-24 lg:pt-32 lg:pb-28 overflow-hidden">
         ...
         <div className="relative z-10 max-w-[1000px] mx-auto px-4 sm:px-6 md:px-8 text-center">
          <motion.div
          ...
          >
            ...
            <p className="font-editorial text-pitch-300 italic text-base md:text-lg mt-6 max-w-lg mx-auto leading-relaxed">
